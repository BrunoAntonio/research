...
i18n.translations = {
  pt: {projectDescription: 'Descrição do projeto', pestDetection: 'Deteção de pragas', 
      ...
      textDescription: 'Projeto InfraPest\n\nColaboração entre a Universidade de Coimbra e o Instituto Politécnico de Leiria para utilização de Inteligência Artificial na Agricultura.\n\nPode saber mais em:',
  ...
  en: {projectDescription: 'Project description', pestDetection: 'Pest detection', 
      ...
      textDescription: 'Infrapest Project\n\nCollaboration between University of Coimbra and Polytechnic Institute of Leiria for the use of Artificial Intelligence in Agriculture.\n\nFind out more on:',
